...
if __name__ == "__main__":
    ...
    ########################Agent#########################
    parser.add_argument('--agent', dest='agent', default='DSR',
                        choices=['ER', 'EWC', 'AGEM', 'CNDPM', 'LWF', 'ICARL', 'GDUMB', 'ASER', 'SCR', 'ER_DVC', 'DSR'],
    ...
    parser.add_argument('--inner_epoch', dest='inner_epoch', default=20,
                        type=int,
                        help='The number of epochs used for one task. (default: %(default)s)')
    parser.add_argument('--base_epoch', dest='base_epoch', default=100,
                        type=int,
                        help='The number of epochs used for base task. (default: %(default)s)')
    parser.add_argument('--batch', dest='batch', default=10,
                        type=int,
                        help='Batch size (default: %(default)s)')
    parser.add_argument('--base_batch', dest='base_batch', default=100,
                        type=int,
                        help='Batch size (default: %(default)s)')
    ...
    ########################Data#########################
    parser.add_argument('--num_tasks', dest='num_tasks', default=11,
                        type=int,
                        help='Number of tasks (default: %(default)s), OpenLORIS num_tasks is predefined')
    parser.add_argument('--base_class', dest='base_class', default=60,
                        type=int,
                        help='Number of base_class for pre-training')
    ...
    ########################GDumb#########################
    parser.add_argument('--minlr', dest='minlr', default=0.001, type=float, help='Minimal learning rate')
    ...
    ########################ER_DVC#######################
    parser.add_argument('--dl_weight', dest='dl_weight', default=4.0, type=float, help='weight of dl loss')
